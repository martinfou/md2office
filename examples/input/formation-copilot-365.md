---
title: Formation Microsoft Copilot 365
author: MD2Office
...
**Avant** (prompt inefficace) : `` Améliore cette story Jira ``

**Après** (prompt efficace avec CTF) :
...
Chaque composant apporte une dimension spécifique pour créer un prompt complet et précis.
...
**Avant** : *** Permettre aux utilisateurs de payer ***
